...
namespace CartPolePhysics.DoublePole.SinglePrecision
{
    ...
    public sealed class CartDoublePolePhysicsRK2 : CartDoublePolePhysics
    {
        ...
        readonly float[] _s2 = new float[6];
        ...
        public CartDoublePolePhysicsRK2(float tau)
            : base(tau) { }
        ...
        public CartDoublePolePhysicsRK2(float[] state)
            : base(state) { }
        ...
        /// <param name="tau">The timestep increment, e.g. 0.01 for 10 millisecond increments.</param>
        /// <param name="state">The cart-pole model state variables.</param>
        public CartDoublePolePhysicsRK2(float tau, float[] state)
            : base(tau, state) { }
        ...
        public CartDoublePolePhysicsRK2(float tau, float[] state, CartDoublePoleEquations equations)
